...
public class LocationManager : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject[] locations = new GameObject[23];

    private Vector3[] locationPosition = new Vector3[23];
    void Start()
    {
        ...
        AssignSpot(TimeManager.dayNumber, TimeManager.weekNumber);
    }

    public void AssignSpot(int dayNum, int weekNum) //sets kid positions according to the story
    {
        switch (weekNum)
        {
            case 0 :
